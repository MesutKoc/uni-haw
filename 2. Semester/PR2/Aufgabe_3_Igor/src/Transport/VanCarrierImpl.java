...
public class VanCarrierImpl extends AbstractContainerCar implements VanCarrier {
    // CREATION
    private VanCarrierImpl(ShipEngine engine, Speed maxSpeed, Mass emptyMass, int bays, int rows, int tiers) {
        super(engine, maxSpeed, emptyMass, bays, rows, tiers);
    }
    
    public static VanCarrier valueOf(ShipEngine engine, Speed maxSpeed, Mass emptyMass, int bays, int rows, int tiers) {
