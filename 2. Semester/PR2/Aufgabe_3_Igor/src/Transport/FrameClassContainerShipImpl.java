...
import Transport.interfaces.FrameClassContainerShip;
import Transport.interfaces.ShipEngine;
import Transport.interfaces.ShipHull;
import java.util.Collection;
import java.util.Set;

public class FrameClassContainerShipImpl implements FrameClassContainerShip {
    // ATTRIBUTES
    private final ContainerShip containerShip;
    
    // CREATION
    private FrameClassContainerShipImpl(ShipHull hull, ShipEngine engine, Speed maxSpeed, int bays, int rows, int tiers) {
        this.containerShip = Entities.containerShip(hull, engine, maxSpeed, bays, rows, tiers);
    }
    
    public static FrameClassContainerShip valueOf(ShipHull hull, ShipEngine engine, Speed maxSpeed, int bays, int rows, int tiers) {
        return new FrameClassContainerShipImpl(hull, engine, maxSpeed, bays, rows, tiers);
    }
