...
import Values.physicsValues.interfaces.PhysicsScalar;

public abstract class AbstractPhysicsScalar<T extends PhysicsScalar> implements PhysicsScalar<T> {
    private final double value;
    
    protected AbstractPhysicsScalar(double value) {
        this.value = value;
    }
