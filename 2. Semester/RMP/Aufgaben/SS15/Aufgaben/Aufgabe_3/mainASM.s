...
testIfPushButtonPressed
            ...
            ldr R4, [R3]			  ;0x80 = 128 -> 1.
            and R4, #0x80             ;S0 maskieren --> S7! ????1/2 
            cmp r4, #0x80             ;S0 testen --> S7!
            movne r0, #0x01           ;Taster gedrückt -> Pin ist 0 2er koplement.
...
outputLEDBar
            ...
            push {r3-r5, lr}    ;gerade Anzahl von Registern!  r5 dummy register! 
            ...
            mov r4, #0x01        ; ein led leuchtet
            lsl    r4, r4, r0	 ; um ein led erhöhen erg in r0 speichern.	
            sub    r4, #0x01     ; leuchten alle LEDs die vor der 1 kommen.
...
REPEAT_01	 									;Zustand: START_WAIT
            ...
            mov R1, #4							;Unseren Text ausgeben auf X und Y Koordinaten.
            mov R2, #16
            bl    SafeTFT

WHILE_02										;Polling von Taste S7
            bl testIfPushButtonPressed
            cmp r0, #0x01						;wenn taste gedrückt wird dann springt er zu endwhile, anstonsten macht er nichts.
            beq ENDWHILE_02
...
ENDWHILE_02										;Zustand: START_DELAY
			...
			mov r8, #0							;setzung des Registers auf den wert 0 (Für die Balkenlaenge)
            mov r0, #0           
            bl    outputLEDBar
...
WHILE_03										;Zustand: RUN
            bl LEDBarEndReached					;Balkenlaenge = 16?
            cmp r0, #1
            beq ENDWHILE_03
