...
charToInt
	...
	sub R1, #'0'   ; Differenz zwischen ASCII R0 und ASCII '0' ...'0' hat dez. 48 und dann kriegt man zB eine 5 dez(53) dann 53-48 -> int 5. 	
	pop {LR, R0}
	bx LR
...
then_01
	...
	mla ACCU, ACCU, R4, R1	; Akkumulieren den Wert aus mehreren dezimalen Ziffern...z.B. Berechnung: 12 = 1 * 10 + 2
endif_01
	b step_01
endfor_01
	mov R0, ACCU			;Ausgabe von dem Ergebnis ...r0= Output Register.
    pop {R5-R7, LR}
	pop {R1-R4}
    bx LR
