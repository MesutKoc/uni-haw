...
class Range2dTest < Test::Unit::TestCase
  ...
  def test_include
   assert_equal(true, Range2d[Range1d[Point1d[1],Point1d[1]],Range1d[Point1d[2],Point1d[2]]].include?(Point2d[Point1d[1],Point1d[2]]))
  ...
  def test_to_a
    assert_equal([Range1d[Point1d[-3], Point1d[-5]], Range1d[Point1d[2], Point1d[2]]],Range2d[Range1d[Point1d[-3], Point1d[-5]],Range1d[Point1d[2],Point1d[2]]].to_a)
    assert_equal([R11,R12],R21.to_a)
